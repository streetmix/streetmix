...
const SPRITE_DEFS = {
  'markings--straight-inbound-light': { id: 'markings--straight-inbound-light' }, // translucent version of arrow
  'markings--straight-outbound-light': { id: 'markings--straight-outbound-light' },
  'markings--straight-inbound': { id: 'markings--straight-inbound' },
  'markings--straight-outbound': { id: 'markings--straight-outbound' },
  'markings--left-inbound': { id: 'markings--left-inbound' },
  'markings--left-outbound': { id: 'markings--left-outbound' },
  'markings--left-straight-inbound': { id: 'markings--left-straight-inbound' },
  'markings--left-straight-outbound': { id: 'markings--left-straight-outbound' },
  'markings--right-inbound': { id: 'markings--right-inbound' },
  'markings--right-outbound': { id: 'markings--right-outbound' },
  'markings--right-straight-inbound': { id: 'markings--right-straight-inbound' },
  'markings--right-straight-outbound': { id: 'markings--right-straight-outbound' },
  'markings--both-inbound': { id: 'markings--both-inbound' },
  'markings--both-outbound': { id: 'markings--both-outbound' },
  'markings--shared-inbound': { id: 'markings--shared-inbound' },
  'markings--shared-outbound': { id: 'markings--shared-outbound' },
  'markings--sharrow-inbound': { id: 'markings--sharrow-inbound' },
  'markings--sharrow-outbound': { id: 'markings--sharrow-outbound' },

  'markings--lane-left': { id: 'markings--lane-left' },
  'markings--lane-right': { id: 'markings--lane-right' },
  'markings--center-lane-left': { id: 'markings--center-lane-left' },
  'markings--center-lane-right': { id: 'markings--center-lane-right' },
  'markings--parking-left': { id: 'markings--parking-left' },
  'markings--parking-right': { id: 'markings--parking-right' },
  'markings--streetcar-track-01': { id: 'markings--streetcar-track-01' }, // lighter (for dark backgrounds)
  'markings--streetcar-track-02': { id: 'markings--streetcar-track-02' }, // darker (for light backgrounds)
  'markings--stripes-diagonal': { id: 'markings--stripes-diagonal' },
  ...
  'lamps--pride-banner-right': { id: 'lamps--pride-banner-right', offsetX: -60 },
  'lamps--pride-banner-left': { id: 'lamps--pride-banner-left', offsetX: -60 },

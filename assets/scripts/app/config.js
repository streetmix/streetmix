...
export const TWITTER_URL_SIGN_IN_CALLBACK_REL = parse(process.env.TWITTER_CALLBACK_URI)
...
export const AUTH0_URL_SIGN_IN_CALLBACK_REL = parse(process.env.AUTH0_CALLBACK_URI)

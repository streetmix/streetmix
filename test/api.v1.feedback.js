...
test('post api/v1/feedback', function (t) {
  ...
  request(app)
    ...
    .end(function (err, res) {
      ...
      t.equal(res.statusCode, 202, 'should return status code of 202 accepted')
    })
  ...
  request(app)
    ...
    .end(function (err, res) {
      ...
      t.equal(res.statusCode, 400, 'should return status code of 400 bad request if no data is sent')
    })
})

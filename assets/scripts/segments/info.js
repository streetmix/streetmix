...
const SPRITE_DEFS = {
  'markings--straight-inbound-light': { id: 'markings--straight-inbound-light', originY: 46.44 }, // translucent version of arrow
  'markings--straight-outbound-light': { id: 'markings--straight-outbound-light', originY: 46.44 },
  'markings--straight-inbound': { id: 'markings--straight-inbound', originY: 46.44 },
  'markings--straight-outbound': { id: 'markings--straight-outbound', originY: 46.44 },
  'markings--left-inbound': { id: 'markings--left-inbound', originY: 46.44 },
  'markings--left-outbound': { id: 'markings--left-outbound', originY: 46.44 },
  'markings--left-straight-inbound': { id: 'markings--left-straight-inbound', originY: 46.44 },
  'markings--left-straight-outbound': { id: 'markings--left-straight-outbound', originY: 46.44 },
  'markings--right-inbound': { id: 'markings--right-inbound', originY: 46.44 },
  'markings--right-outbound': { id: 'markings--right-outbound', originY: 46.44 },
  'markings--right-straight-inbound': { id: 'markings--right-straight-inbound', originY: 46.44 },
  'markings--right-straight-outbound': { id: 'markings--right-straight-outbound', originY: 46.44 },
  'markings--both-inbound': { id: 'markings--both-inbound', originY: 46.44 },
  'markings--both-outbound': { id: 'markings--both-outbound', originY: 46.44 },
  'markings--shared-inbound': { id: 'markings--shared-inbound', originY: 46.44 },
  'markings--shared-outbound': { id: 'markings--shared-outbound', originY: 46.44 },
  'markings--sharrow-inbound': { id: 'markings--sharrow-inbound', originY: 46.44 },
  'markings--sharrow-outbound': { id: 'markings--sharrow-outbound', originY: 46.44 },

  'markings--lane-left': { id: 'markings--lane-left', originY: 48.36 },
  'markings--lane-right': { id: 'markings--lane-right', originY: 48.36 },
  'markings--center-lane-left': { id: 'markings--center-lane-left', originY: 48.36 },
  'markings--center-lane-right': { id: 'markings--center-lane-right', originY: 48.36 },
  'markings--parking-left': { id: 'markings--parking-left', originY: 48.36 },
  'markings--parking-right': { id: 'markings--parking-right', originY: 48.36 },
  'markings--streetcar-track-01': { id: 'markings--streetcar-track-01', originY: 48.36 }, // lighter (for dark backgrounds)
  'markings--streetcar-track-02': { id: 'markings--streetcar-track-02', originY: 45.6 }, // darker (for light backgrounds)
  'markings--stripes-diagonal': { id: 'markings--stripes-diagonal', originY: 56.86 },
  ...
  'lamps--pride-banner-right': { id: 'lamps--pride-banner-right', offsetX: -60, originY: -211.8 },
  'lamps--pride-banner-left': { id: 'lamps--pride-banner-left', offsetX: -60, originY: -211.8 },

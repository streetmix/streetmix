...
1. Install [a modern browser](http://browsehappy.com/). We recommend **Firefox** or **Chrome**. Internet Explorer is not supported. (See `faq-internet-explorer`{.interpreted-text role="ref"}).

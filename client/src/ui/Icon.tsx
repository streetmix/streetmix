...
const ICONS = {
  ...
  pin: [IconPin, 'tabler'],
  'pin-filled': [IconPinFilled, 'tabler'],
  plus: [FaPlus, 'fa'],
  print: [IconPrinter, 'tabler'],
  rain: [IconUmbrella, 'tabler'],
  ...
  'slope-left': [IconArrowDownLeftCircle, 'tabler'],
  'slope-right': [IconArrowDownRightCircle, 'tabler'],
  snow: [IconSnowflake, 'tabler'],

...
export const SEGMENT_WIDTH_RESOLUTION_IMPERIAL = 0.25 / 3.2808 // feet => m
export const SEGMENT_WIDTH_CLICK_INCREMENT_IMPERIAL = 0.25 / 3.2808 // feet => m
export const SEGMENT_WIDTH_DRAGGING_RESOLUTION_IMPERIAL = 0.5 / 3.2808 // feet => m

...
export default class ContributeMenu extends React.PureComponent {
  ...
  render () {
    return (
      <Menu {...this.props}>
        <a href="https://github.com/streetmix/streetmix/" target="_blank" rel="noopener" onClick={this.onClickGitHub}>
          <svg className="icon">
            <use xlinkHref="#icon-github" />
          </svg>
          <FormattedMessage id="menu.contribute.opensource" defaultMessage="Contribute to open source" />
        </a>
        <a href="https://opencollective.com/streetmix/" target="_blank" rel="noopener" onClick={this.onClickDonate}>
          <FormattedMessage id="menu.contribute.donate" defaultMessage="Donate" />
        </a>
        {/* Sticker link is broken
        <a href="https://www.stickermule.com/user/1069909781/stickers" target="_blank" rel="noopener" onClick={this.onClickStickers}>

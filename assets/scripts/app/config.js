...
export const AUTH0_FACEBOOK_URL_SIGN_IN_CALLBACK_REL = process.env.AUTH0_FACEBOOK_CALLBACK_URI
export const AUTH0_GOOGLE_URL_SIGN_IN_CALLBACK_REL = process.env.AUTH0_GOOGLE_CALLBACK_URI
